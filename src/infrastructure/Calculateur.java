...
public abstract class Calculateur extends Thread {
  ...
  private static class Envoi extends TimerTask {
    ...
    public void run() {
      synchronized (destinataire) {
        ...
        // si destinataire en mode asynchrone
        ...
        // si destinataire en mode synchrone
   ...
   * destinée à être implémentée dans les sous-classes de Calculateur.
   * <p>
  ...
  public final void diffuser(String d, Message m) {
	try {
		Groupe groupe = Groupe.toGroupe(d);
